...
$Routes = [
    ...
    '/assign_task' => __DIR__ . '/views/pages/assign_task.views.php',
    '/update_task' => __DIR__ . '/views/pages/update_task.views.php',
    ...
    '/callback' => __DIR__ . '/views/codebridge/integration/callback.php',
    '/private_repo' => __DIR__ . '/views/codebridge/integration/private_repo.php',
    '/send_msg' => __DIR__ . '/views/pages/inc/_send_msg.views.php',
    '/personal_inbox_send_msg' => __DIR__ . '/views/pages/inc/_personal_inbox_send_msg.php',
    '/personal_inbox_delete_msg' => __DIR__ . '/views/pages/inc/_personal_inbox_delete_msg.php',
