...
if (localStorage.getItem('audioContextInitialized') || localStorage.getItem('audioContextInitialized') == true || localStorage.getItem('audioContextInitialized') == 'true' ) {
    ...
    document.addEventListener('click', function () {
        if (!the_audioContext || the_audioContext == '' || the_audioContext == undefined) {
            the_audioContext = new (window.AudioContext || window.webkitAudioContext)();
            localStorage.setItem('audioContextInitialized', 'true');  // Set the flag
        }
