...
$controllers->add_new_documentation();
                                    ...
                                    <div class="projects_content lux_roman">
                                        <div class="container">
                                            <form action="" method="post" enctype="multipart/form-data" >
                                                <div class="mb-3">
                                                    <input type="text" name="documentation_name" class="form-control" placeholder="Enter Documentation Name" >
                                                </div>
                                                <div class="mb-3">
                                                    <textarea name="documentation_desc" class="form-control" id="" placeholder="Enter Documentation Description" cols="30" rows="10"></textarea>
                                                </div>
                                                <div class="mb-3">
                                                    <input type="file" name="documentation_file" id="documentation_file" class="form-control" >
                                                    <div  class="text-danger mt-4 ms-4 mb-4">* Please upload pdf files only</d>
                                                </div>
                                                <div class="mb-3">
                                                   <button type="submit" name="add_new_documentation" class="btn btn-outline-primary mt-4 mb-4" >Add new document</button>
                                                </div>
