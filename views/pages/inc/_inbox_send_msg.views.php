<?php
    ...
    $options = array(
      ...
      $channel_name = "personal_inbox_messages";

      $event_name = "user_id_" . $get_project_id;
      ...
      if($_FILES['repo_upload_file']['name'] !=''){
        ...
        // file upload dir
        $file_upload_dir = './assets/uploads/personal_inbox_messages_upload/';
      ...
      // start the added the repository_msg_id and the code so that we can add it on the insertion
       ...
       // get the last id
       $result_repository_msg_last_id = $controllers->get_the_max_id("repository_msg_id", "personal_inbox_messages");
      ...
      if($message != '' && $_FILES['repo_upload_file']['name'] == ''){
        ...
        //  // get the last id
        //  $result_repository_msg_last_id = $controllers->get_the_max_id("repository_msg_id", "project_discussions");
        ...
        $result_insert_message = $controllers->insert("personal_inbox_messages", "`repository_msg_code`, `repository_msg`, `project_id`, `repository_msg_status`, `msg_sender_user_id`, `msg_sender_user_name`, `file_upload_status`", "'$repository_msg_code', '$message', '$get_project_id', 'file_and_message', '$message_sender_user_id', '$message_sender_user_name', 'file_not_uploaded'");
      ...
      if($message == '' && $_FILES['repo_upload_file']['name'] != ''){
        ...
        //   // get the last id
        //   $repository_msg_last_id = $controllers->get_the_max_id("repository_msg_id", "project_discussions");
      ...
      if($message !='' && $_FILES['repo_upload_file']['name'] !=''){
        ...
        // $result_insert_message = $controllers->insert("project_discussions", "`repository_msg_code`,`project_id`, `repository_msg_status`, `msg_sender_user_id`, `msg_sender_user_name`, `file_upload_status`, `file_name`", "'$repository_msg_code', '$get_project_id', 'file_and_message', '$message_sender_user_id', '$message_sender_user_name', 'file_uploaded'");
        ...
        // $result_insert_message = $controllers->insert("project_discussions", "`repository_msg`, `project_id`, `repository_msg_status`, `msg_sender_user_id`, `msg_sender_user_name`, `file_upload_status`, `file_name`", "'$message', '$get_project_id', 'file_and_message', '$message_sender_user_id', '$message_sender_user_name', 'file_uploaded', '$file_name'");
