<?php
    ...
    $options = array(
      ...
      if($_FILES['repo_upload_file']['name'] !=''){
        ...
        // file upload dir
        $file_upload_dir = './assets/uploads/project_discussions_upload/';
      ...
      if($message != '' && $_FILES['repo_upload_file']['name'] == ''){
        ...
        $result_insert_message = $controllers->insert("project_discussions", "`repository_msg_code`, `repository_msg`, `project_id`, `repository_msg_status`, `msg_sender_user_id`, `msg_sender_user_name`, `file_upload_status`", "'$repository_msg_code', '$message', '$get_project_id', 'file_and_message', '$message_sender_user_id', '$message_sender_user_name', 'file_not_uploaded'");
