                            ...
                            <div class="details_container_info">
                                ...
                                <div class="main_content_section mt-4">
                                    <div class="container m-4 pt-4  pe-5">
                                        <table class="table me-5 table-borderless">
                                            <thead>
                                                <tr>
                                                    <th scope="col">#</th>
                                            ...
                                            <tbody class="">
                                                ...
                                                $result_all_projects = $controllers->create_sql_query("SELECT * FROM `documentations` ORDER BY `documentation_id` DESC LIMIT {$offset}, {$limit}");
                                                ...
                                                if ($result_all_projects) {
                                                    if ($result_all_projects->num_rows > 0) {
                                                        ...
                                                        // </tr>
                                                         ...
                                                         echo '
                                                            <tr class="project_main_col_content">
                                                                <th scope="row">'. $row['documentation_id'] .'</th>
                                                         ...
                                                         ';
                                                            ...
                                                            // <div
                                                            // class="d-none col-12 p-2 m-4 mt-2 mb-2 project_main_col_content  project_col_main ">
                                ...
                                <div class="main_content_section d-none mt-4">
                                    ...
                                    <div class="container">
                                        <nav aria-label="...">
                                            <ul class="pagination">
                                                ...
                                                $result_total_page = $controllers->get_all_data("documentations");
                                                // $result_total_page = $controllers->get_all_data("projects");
