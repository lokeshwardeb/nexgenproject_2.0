                                                            ...
                                                            if($result_get_task_info){
                                                                if($result_get_task_info->num_rows > 0){
                                                                    ...
                                                                    while($row_task_info = $result_get_task_info->fetch_assoc()){
                                                                        $db_user_id = $row_task_info['user_id'];
                                                                        $db_user_name = $row_task_info['user_name'];
                                                            ...
                                                            if($result_get_all_users){
                                                                if($result_get_all_users->num_rows > 0){
                                                                    ...
                                                                    while($row_get_users = $result_get_all_users->fetch_assoc()){
                                                                        ...
                                                                        // check if the task is given to the user
                                                                        if($get_main_user_id == $task_assigned_user_id){
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <div class="form-check">
                                                                                ...
                                                                                if($assigned_status || $assigned_status == true){
                                                                                    // the user has been assigned the task and it should show checked
                                                                                    echo 'checked';
                                                                                }
                                                                            ...
                                                                            echo ' class="form-check-input" name="assign_users[]" type="checkbox"
                                                                                            ...
                                                                                            <label class=" text-primary form-check-label"
                                                                                                for="flexCheckDefault'. $get_main_user_id .'">
                                                                                                ' . $get_main_user_name . '
                                                                                            </label>
