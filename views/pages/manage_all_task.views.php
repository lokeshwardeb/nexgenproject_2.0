...
$active_name = "All tasks";
// $dashboard_active_class_name = "sidebar_btn_active";
// $all_tasks_active_class_name = "sidebar_btn_active";
// sidebar_btn_active
                                    ...
                                    <div class=" mt-4 pt-4 ">
                                            <table class="table cus_hover mt-4 mb-4 " style="width:100%"
                                                ...
                                                <tbody>
                                                    ...
                                                    $result_all_tasks = $controllers->get_all_data("tasks", " 1 ORDER BY `tasks`.`task_id` DESC ");

                                                    if ($result_all_tasks) {
                                                        if ($result_all_tasks->num_rows > 0) {
                                                            $sl_no = 1;
                                                            while ($row = $result_all_tasks->fetch_assoc()) {
