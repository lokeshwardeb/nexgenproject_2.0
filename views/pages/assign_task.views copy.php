                                                ...
                                                <div class="assign_task_form lux_roman mt-4 fw-bold ">
                                                    <form action="" method="post">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            // $result_assigned_users_check = $controllers->get_all_data("task_assigned_users");
                                                            ...
                                                            // $sql_task_assign_join = "SELECT * FROM users u INNER JOIN task_assigned_users au ON u.user_id = au.task_assigned_user_id INNER JOIN tasks ts ON au.task_id = ts.task_id WHERE au.task_id = '15';";
                                                            

                                                            $sql_task_assign_join = "SELECT * FROM users u INNER JOIN task_assigned_users au ON u.user_id = au.task_assigned_user_id WHERE au.task_id = '$get_task_id'; ";



                                                            $result_task_assign_join = $controllers->create_sql_query($sql_task_assign_join);
                                                                ...
                                                                if ($result_task_assign_join->num_rows) {
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        echo ' class="form-check-input" name="assign_users[]" type="checkbox"
                                                                                value="' . $row_task_assign['user_id'] . '" id="flexCheckDefault">
                                                                            <label class=" text-primary form-check-label"
                                                                                for="flexCheckDefault">
                                                                                ' . $row_task_assign['user_name'] . '
                                                                            </label>
